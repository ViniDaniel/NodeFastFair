    ...
    <div className={styles.cardProduto}>
      ...
      <div className={styles.infoProduto}>
        <h2 className={styles.nomeProduto}>
          {produto.nome}
          <span className={styles.pesoProduto}> -- {produto.peso} Gramas</span>
        </h2>
        ...
        {detalhes && (
          <div className={styles.detalhesProduto}>
            <div className={styles.flex}>
              ...
              <ColaboradorCardProduto feirante={produto.feiranteId} />
            </div>

            <div className={styles.flex}>
              <strong>Categoria:</strong>
              <CardCategoria categoria={produto.categoria?.nome} />{" "}
            </div>
            <br />
